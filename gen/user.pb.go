...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x03, 0x67, 0x65, 0x6e, 0x22, 0x8d, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x8e, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70,
	...
	0x66, 0x75, 0x6c, 0x6c, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x36, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x27, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x73, 0x12, 0x0c, 0x2e, 0x67, 0x65, 0x6e, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_proto_user_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: gen.Request
	(*Response)(nil), // 1: gen.Response
}
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: gen.UserService.GetUsers:input_type -> gen.Request
	1, // 1: gen.UserService.GetUsers:output_type -> gen.Response
...
type UserServiceClient interface {
	GetUsers(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/gen.UserService/GetUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedUserServiceServer) GetUsers(context.Context, *Request) (*Response, error) {
...
func _UserService_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gen.UserService/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsers(ctx, req.(*Request))
	}
